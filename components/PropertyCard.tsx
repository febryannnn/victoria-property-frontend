      ...
      <article className="card-property group">
        <div className="relative aspect-[4/3] overflow-hidden">
          ...
          <div className="absolute top-2 left-2 flex flex-wrap gap-1">
            <span
              className={`${statusStyles[status]} text-xs px-2 py-0.5 border rounded-full bg-victoria-red text-white`}
            >
              {statusText[status]}
            </span>

            {isNew && (
              <span className="text-xs px-2 py-0.5 border border-victoria-yellow bg-victoria-yellow/20 text-victoria-yellow rounded-full">
                Baru
              </span>
            )}
          </div>
